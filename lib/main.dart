                  ...
                  return new ListTile(
                    ...
                    leading: new CircleAvatar(
                      ...
                      child: new Text("${_features[index]['properties']['mag']}",
                          style: new TextStyle(fontSize: 16.5, fontWeight: FontWeight.normal,color: Colors.white,fontStyle: FontStyle.italic)),
                    ),
...
Future<Map> getQuakes() async{
  String appUrl='https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_hour.geojson';
